...
::: {.callout-tip icon="false"}
## Solution
Supervised learning is task driven and used for pre categorized data. It involves regression and classification problems and there is a target variable. 
Unsupervised learning is more data driven and uses patters to categorize data into groups. 
...
::: {.callout-tip icon="false"}
## Solution
Generally describe relationships or trends in the data. Linear and parametric models are good for this.
...
::: {.callout-tip icon="false"}
## Solution
Unpack the how and why of what inputs affect the target variable. 
Use the data to see how a variable x influences another variable y. 
...
::: {.callout-tip icon="false"}
## Solution
Use data (predictors) to predict the outcome of a target variable. 
Not understand the how or why, just use data to try to predict the outcome. 
...
::: {.callout-tip icon="false"}
## Solution
Mechanistic models explain why a system behaves a certain way using 
